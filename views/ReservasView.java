...
public class ReservasView extends JFrame {
	...
	private void salvarReserva() {
		...
		Reserva novaReserva = new Reserva(Date.valueOf(dataEntrada), Date.valueOf(dataSaida),
				txtValor.getText(), txtFormaPagamento.getSelectedItem().toString());
		reservasController.salvar(novaReserva);

		JOptionPane.showMessageDialog(contentPane, "Registro salvo Número, numero da Reserva: "
				+ novaReserva.getId().toString());
