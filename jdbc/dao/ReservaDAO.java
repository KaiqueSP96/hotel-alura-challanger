...
public class ReservaDAO {
	...
	public List<Reserva> buscar() {
		...
		try {
			String sql = "SELECT idReserva, dataEntrada, dataSaida, valor, formaPagamento FROM reservas";
	...
	public List<Reserva> buscarId(String id) {
		...
		try {
			...
			String sql = "SELECT idReserva, dataEntrada, dataSaida, valor, formaPagamento FROM reservas WHERE idReserva = ?";
	...
	public void atualizar(Date dataEntrada, Date dataSaida, String valor, String formaPagamento, Integer id) {
		try (PreparedStatement stm = connection
				.prepareStatement("UPDATE reservas SET datEntrada = ?, dataSaida = ?, valor = ?, formaPagamento = ? WHERE id = ?")) {
